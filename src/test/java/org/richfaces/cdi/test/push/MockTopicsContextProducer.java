...
public class MockTopicsContextProducer {

    @Produces
    @RequestScoped
    public MockTopicsContext getTopicsContext() {
        return new MockTopicsContext();
    }

    @Veto
    public static class MockTopicsContext extends TopicsContext {
